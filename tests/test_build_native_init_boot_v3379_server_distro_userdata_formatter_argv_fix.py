"""Regression tests for V3379 server-distro D4C userdata formatter argv fix source build."""
...
class BuildNativeInitBootV3379ServerDistroFormatterFixTests(unittest.TestCase):
    def test_builder_identity_and_required_markers(self) -> None:
        self.assertEqual(builder.CYCLE, "V3379")
        self.assertEqual(builder.INIT_VERSION, "0.11.137")
        self.assertEqual(builder.INIT_BUILD, "v3379-server-distro-userdata-formatter-argv-fix")
    ...
    def test_command_table_registers_d4_surface_with_expected_risk_flags(self) -> None:
        ...
        for handler in (
            ...
            "handle_userdata_appliance_formatter_probe",
        ...
        self.assertIn("a90_server_distro_userdata_formatter_probe_cmd(argv, argc);", dispatch)
