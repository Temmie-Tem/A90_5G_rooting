...
runner = load_script("workspace/public/src/scripts/revalidation/build_native_init_boot_v3143_doomgeneric_sfx_stream.py")


class NativeDoomgenericSfxStreamSourceV3143Tests(unittest.TestCase):
    def test_loop_only_enables_sfx_sound(self) -> None:
        source = runner.v3143_adapter_source()
        ...
        self.assertIn("a90.doomgeneric.v3143.audio=real-sfx-pcm-stream-music-disabled", source)
