"""Tests for the V2782 audio stage module live validation runner."""
...
RUNNER = REPO / "workspace/public/src/scripts/revalidation/native_audio_stage_module_device_validation_handoff_v2782.py"
...
class NativeAudioStageModuleDeviceValidationV2782(unittest.TestCase):
    ...
    def test_runner_validates_prereq_markers(self) -> None:
        ...
        for marker in [
            ...
            "v2782-audio-stage-module-device-pass",
        ]:
