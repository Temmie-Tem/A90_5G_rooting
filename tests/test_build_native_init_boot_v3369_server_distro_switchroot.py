"""Regression tests for V3369 server-distro D3B switch_root source build."""
...
builder = load_script("workspace/public/src/scripts/revalidation/build_native_init_boot_v3369_server_distro_switchroot.py")


class BuildNativeInitBootV3369ServerDistroSwitchrootTests(unittest.TestCase):
    def test_builder_identity_and_required_markers(self) -> None:
        self.assertEqual(builder.CYCLE, "V3369")
        self.assertEqual(builder.INIT_VERSION, "0.11.130")
        self.assertEqual(builder.INIT_BUILD, "v3369-server-distro-switchroot")
