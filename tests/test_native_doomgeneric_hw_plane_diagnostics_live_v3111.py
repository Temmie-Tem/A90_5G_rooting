...
runner = load_script("workspace/public/src/scripts/revalidation/native_doomgeneric_hw_plane_diagnostics_live_validation_v3111.py")


class NativeDoomgenericHwPlaneDiagnosticsLiveV3111Tests(unittest.TestCase):
    def test_identity_and_flash_contract(self) -> None:
        self.assertEqual(runner.RUN_ID, "V3111")
        self.assertEqual(runner.CANDIDATE_VERSION, "0.10.110")
        self.assertEqual(runner.CANDIDATE_TAG, "v3110-doomgeneric-hw-plane-diagnostics")
        self.assertEqual(
            runner.CANDIDATE_SHA256,
            "71257ef7fdc9636caa5d40d0c956a59cce36bce7a61ba59beed268bf77d34f57",
        )
        ...
        self.assertIn("boot_linux_v3110_doomgeneric_hw_plane_diagnostics.img", joined)
    ...
    def test_preflight_and_report_contract(self) -> None:
        ...
        self.assertIn("Native Init V3111 DOOMGENERIC Hardware Plane Diagnostics Live Validation", report)
