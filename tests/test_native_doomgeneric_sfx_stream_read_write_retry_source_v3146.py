...
runner = load_script("workspace/public/src/scripts/revalidation/build_native_init_boot_v3146_doomgeneric_sfx_stream_read_write_retry.py")


class NativeDoomgenericSfxStreamReadWriteRetrySourceV3146Tests(unittest.TestCase):
    def test_loop_only_enables_sfx_sound(self) -> None:
        source = runner.v3146_adapter_source()
        ...
        self.assertIn("a90.doomgeneric.v3146.audio=real-sfx-pcm-stream-read-write-retry-music-disabled", source)
