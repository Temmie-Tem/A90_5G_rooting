...
runner = load_script("workspace/public/src/scripts/revalidation/build_native_init_boot_v3144_doomgeneric_sfx_stream_nonblocking.py")


class NativeDoomgenericSfxStreamNonblockingSourceV3144Tests(unittest.TestCase):
    def test_loop_only_enables_sfx_sound(self) -> None:
        source = runner.v3144_adapter_source()
        ...
        self.assertIn("a90.doomgeneric.v3144.audio=real-sfx-pcm-stream-nonblocking-music-disabled", source)
