...
class ServerDistroWsta73PersistentArmingPacketTests(unittest.TestCase):
    ...
    def test_valid_prepare_to_arm_renders_arming_packet(self) -> None:
        ...
        self.assertIn("--ack-packet-filter-mutation", packet["wsta58_live_command_template"])
        self.assertIn("--force-packet-filter-restore-proof", packet["wsta58_live_command_template"])
        ...
        self.assertIn("--ack-packet-filter-mutation", packet["operator_acknowledgements_required"])
        self.assertIn("--force-packet-filter-restore-proof", packet["operator_acknowledgements_required"])
