...
runner = load_script(
    "workspace/public/src/scripts/revalidation/build_native_init_boot_v3173_badapple_nyan_pcm_duration.py"
)


class NativeVideoBadappleNyanPcmDurationSourceV3173Tests(unittest.TestCase):
    def test_v3173_identity_and_required_markers(self) -> None:
        self.assertEqual(runner.CYCLE, "V3173")
        self.assertEqual(runner.INIT_VERSION, "0.11.16")
        self.assertEqual(runner.INIT_BUILD, "v3173-badapple-nyan-pcm-duration")

        required = b"\n".join(runner.REQUIRED_STRINGS)
        self.assertIn(b"0.11.16", required)
        self.assertIn(b"v3173-badapple-nyan-pcm-duration", required)
        ...
        self.assertIn(b"menu.demo.badapple.audio_duration_ms=232093", required)
        self.assertIn(b"menu.demo.badapple.audio_tail_pad_ms=0", required)
        self.assertIn(b"menu.demo.badapple.audio_duration_source=pcm-file-size", required)
        self.assertIn(b"menu.demo.badapple.pcm_duration_wait=expected-duration", required)
        self.assertIn(b"menu.demo.nyan.audio_duration_ms=10000", required)
        self.assertIn(b"menu.demo.nyan.audio_tail_pad_ms=0", required)
        self.assertIn(b"menu.demo.nyan.audio_duration_source=pcm-file-size", required)
    ...
    def test_badapple_and_nyan_menu_use_pcm_exact_durations(self) -> None:
        ...
        self.assertIn('"--duration-ms", "232093"', badapple)
        self.assertIn("menu.demo.badapple.audio_duration_ms=232093", badapple)
        self.assertIn("menu.demo.badapple.audio_tail_pad_ms=0", badapple)
        self.assertIn("menu.demo.badapple.audio_duration_source=pcm-file-size", badapple)
        self.assertIn("menu.demo.badapple.pcm_duration_wait=expected-duration", badapple)
        self.assertNotIn("232800", badapple)
        self.assertNotIn("audio_tail_pad_ms=710", badapple)
        self.assertIn('"--duration-ms", "10000"', nyan)
        self.assertIn("menu.demo.nyan.audio_duration_ms=10000", nyan)
        self.assertIn("menu.demo.nyan.audio_tail_pad_ms=0", nyan)
        self.assertIn("menu.demo.nyan.audio_duration_source=pcm-file-size", nyan)
        self.assertIn("menu.demo.nyan.pcm_duration_wait=expected-duration", nyan)
        self.assertNotIn("11000", nyan)
        self.assertNotIn("audio_tail_pad_ms=1000", nyan)
    ...
    def test_manifest_metadata_records_new_readahead_and_tail_policy(self) -> None:
        ...
        self.assertIn('"source_baseline": "v3172-badapple-nyan-av-stutter-audio-tail"', source)
        self.assertIn('"badapple_audio_duration_ms": 232093', source)
        self.assertIn('"badapple_pcm_duration_pad_ms": 0', source)
        self.assertIn('"badapple_pcm_size_bytes": 44561952', source)
        self.assertIn('"nyan_audio_duration_ms": 10000', source)
        self.assertIn('"nyan_pcm_duration_pad_ms": 0', source)
        ...
        self.assertIn('"pcm_duration_wait": "expected-duration-for-full-demo"', source)
        self.assertIn("periodic-stutter-check", source)
        self.assertIn("pcm-duration-clean-menu-return", source)
