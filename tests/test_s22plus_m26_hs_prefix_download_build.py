...
SCRIPT = Path("workspace/public/src/scripts/revalidation/build_s22plus_m26_hs_prefix_download.py")
SOURCE = Path("workspace/public/src/native-init/s22plus_init_m26_hs_prefix_download.c")
...
def load_module():
    ...
    spec = importlib.util.spec_from_file_location("build_s22plus_m26_hs_prefix_download", SCRIPT)
...
class S22PlusM26HsPrefixDownloadBuildTest(unittest.TestCase):
    def setUp(self):
        self.module = load_module()

    def test_variant_constants(self):
        self.assertEqual(self.module.MARKER, "S22_NATIVE_INIT_M26_HS_PREFIX_DOWNLOAD")
        self.assertEqual(self.module.M26_MODULES_RAMDISK, "s22plus_m26_hs_only_usb2.modules")
        self.assertEqual(self.module.EXPECTED_HS_ONLY_COUNT, 40)
        self.assertEqual(self.module.DEFAULT_PREFIXES, (0, 24, 25, 27, 28, 30, 33, 40))
        self.assertEqual(self.module.prefix_label(0), "P00")
        self.assertEqual(self.module.prefix_label(40), "P40")

    def test_source_is_download_discriminator_not_acm_park(self):
        text = SOURCE.read_text(encoding="utf-8")
        self.assertIn("S22_NATIVE_INIT_M26_HS_PREFIX_DOWNLOAD", text)
        self.assertIn("reboot_request=download", text)
        self.assertIn("modules_hs_only_usb2=/s22plus_m26_hs_only_usb2.modules", text)
