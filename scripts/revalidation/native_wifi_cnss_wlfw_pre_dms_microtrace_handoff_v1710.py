#!/usr/bin/env python3
"""V1710 one-run CNSS WLFW pre-DMS microtrace handoff."""
...
CYCLE = "V1710"
V1709_OUT = REPO_ROOT / "tmp" / "wifi" / "v1709-cnss-wlfw-pre-dms-microtrace-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v1709/dev/__properties__"
DEFAULT_OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v1710-cnss-wlfw-pre-dms-microtrace-handoff"
DEFAULT_REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V1710_CNSS_WLFW_PRE_DMS_MICROTRACE_HANDOFF_2026-06-02.md"
)
TEST_EXPECT_VERSION = "A90 Linux init 0.9.131 (v1709-cnss-wlfw-pre-dms-microtrace)"
TEST_LOG_PATH = "/cache/native-init-wifi-test-boot-v1709.log"
TEST_SUMMARY_PATH = "/cache/native-init-wifi-test-boot-v1709.summary"
TEST_HELPER_RESULT_PATH = "/cache/native-init-wifi-test-boot-v1709-helper.result"
DMESG_PATTERN = (
    base.DMESG_PATTERN.replace("A90v1699", "A90v1709")
    + "|wlfw_cal_mutex_call|wlfw_cal_mutex_retcheck|wlfw_mutex_call|wlfw_mutex_retcheck"
    + "|wlfw_cond_call|wlfw_cond_retcheck|wlfw_cond_rsp_call|wlfw_cond_rsp_retcheck"
)
VALID_MICROTRACE_LABELS = {
...
def configure_base() -> None:
    ...
    base.VALID_NONLOG_LABELS = set(VALID_MICROTRACE_LABELS)
    base.base.CYCLE = CYCLE
    base.base.V1690_OUT = V1709_OUT
    base.base.base.V1687_OUT = V1709_OUT
    base.base.base.DEFAULT_SOURCE_MANIFEST = V1709_OUT / "manifest.json"
    base.base.base.DEFAULT_TEST_IMAGE = V1709_OUT / "boot_linux_v1709_cnss_wlfw_pre_dms_microtrace.img"
    base.base.base.LOCAL_PROPERTY_ROOT = V1709_OUT / "property-runtime" / "layout" / "dev" / "__properties__"
...
def render_report(result: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- microtrace non-log label: `{gate.get('nonlog_label')}`",
