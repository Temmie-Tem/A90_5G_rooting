#!/usr/bin/env python3
"""Build V2060 native DIAG query-only pre-wlanmdsp trigger test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2060-diag-query-only-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v2060/dev/__properties__"
EXPECTED_HELPER_MARKER = "a90_android_execns_probe v394"
EXPECTED_HELPER_SHA256 = "19acfcc77a06083d2e9f26e4b51468af12bc8c3e8782c48367cce2aa3cfcaa8d"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2060_DIAG_QUERY_ONLY_SOURCE_BUILD_2026-06-04.md"
)
HELPER_FLAGS = (
    ...
    "-DA90_WIFI_TEST_BOOT_DIAG_QUERY_ONLY_PROBE=1",
)
...
def configure_base() -> None:
    ...
    replacements = {
        ...
        "--cycle-label": "v2060",
        "--init-version": "0.9.209",
        "--init-build": "v2060-diag-query-only",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2060_diag_query_only"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v394_diag_query_only"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2060_diag_query_only.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2060_diag_query_only.img"),
        "--wifi-test-klog-prefix": "A90v2060",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2060.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2060.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2060.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2060-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2060.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2060-supervisor.pid",
