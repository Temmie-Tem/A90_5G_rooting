#!/usr/bin/env python3
"""Build V2042 native ota-firewall readwrite bridge test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2042-ota-firewall-ruleset-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v2042/dev/__properties__"
EXPECTED_HELPER_MARKER = "a90_android_execns_probe v387"
EXPECTED_HELPER_SHA256 = "65ea5b7b2e968ebd0ed0d8087657097ce83a583eb4701cec29a6ca4aa564cda9"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2042_OTA_FIREWALL_RULESET_SOURCE_BUILD_2026-06-04.md"
)
HELPER_FLAGS = (
    ...
    "-DA90_WIFI_TEST_BOOT_TFTP_OTA_FIREWALL_RULESET_TMPFS=1",
)
...
def configure_base() -> None:
    ...
    replacements = {
        ...
        "--cycle-label": "v2042",
        "--init-version": "0.9.202",
        "--init-build": "v2042-ota-firewall-ruleset",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2042_ota_firewall_ruleset"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v387_ota_firewall_ruleset"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2042_ota_firewall_ruleset.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2042_ota_firewall_ruleset.img"),
        "--wifi-test-klog-prefix": "A90v2042",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2042.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2042.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2042.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2042-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2042.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2042-supervisor.pid",
