#!/usr/bin/env python3
"""Build V2064 native bounded DIAG DCI canary-mask test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2064-dci-canary-mask-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v2064/dev/__properties__"
EXPECTED_HELPER_MARKER = "a90_android_execns_probe v396"
EXPECTED_HELPER_SHA256 = "6778988410fe17aced5884569608c08e5a081a1f3da3f590483502551f9ad7ec"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2064_DCI_CANARY_MASK_SOURCE_BUILD_2026-06-04.md"
)
HELPER_FLAGS = (
    ...
    "-DA90_WIFI_TEST_BOOT_DIAG_DCI_CANARY_MASK_PROBE=1",
)
...
def configure_base() -> None:
    ...
    replacements = {
        ...
        "--cycle-label": "v2064",
        "--init-version": "0.9.211",
        "--init-build": "v2064-dci-canary-mask",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2064_dci_canary_mask"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v396_dci_canary_mask"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2064_dci_canary_mask.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2064_dci_canary_mask.img"),
        "--wifi-test-klog-prefix": "A90v2064",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2064.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2064.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2064.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2064-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2064.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2064-supervisor.pid",
