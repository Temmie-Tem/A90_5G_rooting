...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--host-jsonl", default="tmp/soak/native-long-soak-v149-host.jsonl")
    parser.add_argument("--device-jsonl", default="tmp/soak/native-long-soak-v149-device.jsonl")
    parser.add_argument("--out-md", default="tmp/soak/native-long-soak-v149-report.md")
    parser.add_argument("--out-json", default="tmp/soak/native-long-soak-v149-report.json")
