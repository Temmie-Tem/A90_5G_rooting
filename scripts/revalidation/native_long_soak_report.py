...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--host-jsonl", default="tmp/soak/native-long-soak-v148-host.jsonl")
    parser.add_argument("--device-jsonl", default="tmp/soak/native-long-soak-v148-device.jsonl")
    parser.add_argument("--out-md", default="tmp/soak/native-long-soak-v148-report.md")
    parser.add_argument("--out-json", default="tmp/soak/native-long-soak-v148-report.json")
