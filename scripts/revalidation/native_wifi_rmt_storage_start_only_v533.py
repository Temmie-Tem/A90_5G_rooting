...
DEFAULT_HELPER_SHA256 = "be213411b81f344c4c2a4bc783e88b2c9b089988da01e98302f2ad144794c621"
DEFAULT_HELPER_MARKER = "a90_android_execns_probe v71"
...
def classify(args: argparse.Namespace,
    ...
    if args.command == "plan":
        return "v533-rmt-storage-start-only-plan-ready", True, "plan-only; no device command executed", "deploy helper v71 and run preflight", False
    ...
    if helper_result == "rmt-window-pass":
        return "v533-rmt-storage-window-pass", True, "rmt_storage stayed observable through the bounded window and cleaned up", "advance to companion replay with v71 surfaces", True
