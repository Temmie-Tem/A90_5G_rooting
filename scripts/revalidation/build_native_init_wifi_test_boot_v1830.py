#!/usr/bin/env python3
"""Build V1830 QIPCRTR observed-local-node bind observer test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v1830-qipcrtr-local-node-bind-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v1830/dev/__properties__"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V1830_QIPCRTR_LOCAL_NODE_BIND_SOURCE_BUILD_2026-06-03.md"
)
...
def configure_base() -> None:
    ...
    prev.DEFAULT_ARGS = [
        ...
        "0.9.160",
        "--init-build",
        "v1830-qipcrtr-local-node-bind",
        "--out-dir",
        str(OUT_DIR),
        "--init-binary",
        str(OUT_DIR / "init_v1830_qipcrtr_local_node_bind"),
        "--helper-binary",
        str(OUT_DIR / "a90_android_execns_probe_v351"),
        "--ramdisk-cpio",
        str(OUT_DIR / "ramdisk_v1830_qipcrtr_local_node_bind.cpio"),
        "--boot-image",
        str(OUT_DIR / "boot_linux_v1830_qipcrtr_local_node_bind.img"),
        "--wifi-test-klog-prefix",
        "A90v1830",
        "--wifi-test-disable",
        "/cache/native-init-wifi-test-boot-v1830.disable",
        "--wifi-test-log",
        "/cache/native-init-wifi-test-boot-v1830.log",
        "--wifi-test-summary",
        "/cache/native-init-wifi-test-boot-v1830.summary",
        "--wifi-test-helper-result",
        "/cache/native-init-wifi-test-boot-v1830-helper.result",
        "--wifi-test-pid",
        "/cache/native-init-wifi-test-boot-v1830.pid",
        "--wifi-test-watcher-pid",
        "/cache/native-init-wifi-test-boot-v1830-supervisor.pid",
        "--wifi-test-watch-sec",
        "90",
