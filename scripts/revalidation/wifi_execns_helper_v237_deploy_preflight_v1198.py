#!/usr/bin/env python3
"""V1198 execns helper v237 deploy/preflight wrapper (same binary as V1197)."""
...
deploy.DEFAULT_OUT_DIR = deploy.Path("tmp/wifi/v1198-execns-helper-v237-deploy")
...
deploy.DEPLOY_PLAN_VERSION = "V1198"
deploy.DEPLOY_LOG_PREFIX = "v1198g"
deploy.SUMMARY_TITLE = "v1198g Execns Helper v237 Deploy Preflight"
deploy.APPROVAL_PHRASE = (
    "approve v1198 deploy execns helper v237 only; "
