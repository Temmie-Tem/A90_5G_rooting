#!/usr/bin/env python3
"""Collect read-only pstore/ramoops feasibility evidence."""
...
DEFAULT_EXPECT_VERSION = "A90 Linux init 0.9.57 (v157)"
...
def default_output_path() -> Path:
    ...
    return REPO_ROOT / "tmp" / "pstore" / f"a90-pstore-v157-{stamp}.txt"
...
def main() -> int:
    ...
    lines = [
        "A90 HOST PSTORE FEASIBILITY",
        f"generated={dt.datetime.now(dt.timezone.utc).isoformat()}",
        "policy=read-only; no pstore mount and no reboot persistence test",
