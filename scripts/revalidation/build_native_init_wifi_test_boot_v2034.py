#!/usr/bin/env python3
"""Build V2034 native RFS fallback + passive logdw TFTP transfer test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2034-rfs-fallback-logdw-transfer-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v2034/dev/__properties__"
EXPECTED_HELPER_MARKER = "a90_android_execns_probe v383"
EXPECTED_HELPER_SHA256 = "4d0b3523e43a2343a8bd6878a2acc1ef3b5f19c32c783605ce1614b5745dca15"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2034_RFS_FALLBACK_LOGDW_TRANSFER_SOURCE_BUILD_2026-06-04.md"
)
HELPER_FLAGS = ("-DA90_WIFI_TEST_BOOT_TFTP_LOGDW_SINK=1",)
...
def configure_base() -> None:
    ...
    replacements = {
        ...
        "--cycle-label": "v2034",
        "--init-version": "0.9.198",
        "--init-build": "v2034-rfs-fallback-logdw-transfer",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2034_rfs_fallback_logdw_transfer"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v383_logdw"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2034_rfs_fallback_logdw_transfer.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2034_rfs_fallback_logdw_transfer.img"),
        "--wifi-test-klog-prefix": "A90v2034",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2034.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2034.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2034.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2034-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2034.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2034-supervisor.pid",
