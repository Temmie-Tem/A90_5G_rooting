#!/usr/bin/env python3
"""V1778 one-run WLAN-PD service-object policy-load handoff."""
...
CYCLE = "V1778"
V1777_OUT = REPO_ROOT / "tmp" / "wifi" / "v1777-service-object-policy-load-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v1777/dev/__properties__"
DEFAULT_OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v1778-service-object-policy-load-handoff"
DEFAULT_REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V1778_SERVICE_OBJECT_POLICY_LOAD_HANDOFF_2026-06-03.md"
)


def configure_base() -> None:
    base.prev.CYCLE = CYCLE
    base.prev.V1735_OUT = V1777_OUT
    ...
    base.prev.base.V1726_OUT = V1777_OUT
    ...
    base.prev.base.prev.V1687_OUT = V1777_OUT
    base.prev.base.prev.DEFAULT_SOURCE_MANIFEST = V1777_OUT / "manifest.json"
    base.prev.base.prev.DEFAULT_TEST_IMAGE = V1777_OUT / "boot_linux_v1777_service_object_policy_load.img"
    base.prev.base.prev.LOCAL_PROPERTY_ROOT = V1777_OUT / "property-runtime" / "layout" / "dev" / "__properties__"
    ...
    base.prev.base.prev.TEST_EXPECT_VERSION = "A90 Linux init 0.9.142 (v1777-service-object-policy-load)"
    base.prev.base.prev.TEST_LOG_PATH = "/cache/native-init-wifi-test-boot-v1777.log"
    base.prev.base.prev.TEST_SUMMARY_PATH = "/cache/native-init-wifi-test-boot-v1777.summary"
    base.prev.base.prev.TEST_HELPER_RESULT_PATH = "/cache/native-init-wifi-test-boot-v1777-helper.result"
    base.prev.base.prev.DMESG_PATTERN = (
        "A90v1777|wlan_pd_service_object_visible_trigger|wlan_pd_service_object_visible|"
...
def classify_gate(args: Any,
    ...
    if not version_ok:
        return f"{args.cycle.lower()}-test-boot-version-missing", False, "expected V1777 test boot version was not collected", details
    if not rollback_ok:
...
def render_report(result: dict[str, Any]) -> str:
    ...
    lines = [
        f"# Native Init {cycle} Service-object Policy-load Handoff",
        "",
        "## Summary",
        "",
        f"- Cycle: `{cycle}`",
