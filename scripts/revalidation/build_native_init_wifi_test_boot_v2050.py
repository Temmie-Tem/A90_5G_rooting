#!/usr/bin/env python3
"""Build V2050 native passive DIAG pre-wlanmdsp trigger test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2050-passive-diag-pre-wlanmdsp-trigger-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v2050/dev/__properties__"
EXPECTED_HELPER_MARKER = "a90_android_execns_probe v390"
EXPECTED_HELPER_SHA256 = "816dc5f316dbb31afe82d23e1993936e37c9b486ca39b6c3ce9a2e28fb149f74"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2050_PASSIVE_DIAG_PRE_WLANMDSP_TRIGGER_SOURCE_BUILD_2026-06-04.md"
)
HELPER_FLAGS = (
    ...
    "-DA90_WIFI_TEST_BOOT_PASSIVE_DIAG_SINK=1",
)
...
def configure_base() -> None:
    ...
    replacements = {
        ...
        "--cycle-label": "v2050",
        "--init-version": "0.9.205",
        "--init-build": "v2050-passive-diag-pre-wlanmdsp-trigger",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2050_passive_diag_pre_wlanmdsp_trigger"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v390_passive_diag_pre_wlanmdsp_trigger"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2050_passive_diag_pre_wlanmdsp_trigger.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2050_passive_diag_pre_wlanmdsp_trigger.img"),
        "--wifi-test-klog-prefix": "A90v2050",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2050.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2050.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2050.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2050-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2050.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2050-supervisor.pid",
