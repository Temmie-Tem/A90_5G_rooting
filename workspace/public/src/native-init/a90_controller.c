...
static bool wifi_read_only(int argc, char **argv) {
    ...
    if ((argc == 2 || argc == 3) && arg_equals(argv, argc, 1, "events")) {
        return true;
    }
...
static bool command_allowed_during_menu_ex(const char *name, int argc, char **argv) {
    ...
    /* boot-write-e1/e2/e3a/e3b/e4/e5 (§0.2 write rungs) are intentionally NOT allowed during the auto-menu: they
...
static const struct controller_policy_case policy_cases[] = {
    ...
    { "menu block wifi dhcp", 2, { "wifi", "dhcp" }, false, false },
    { "menu block wifi ping", 2, { "wifi", "ping" }, false, false },
    { "menu block wifi cleanup", 2, { "wifi", "cleanup" }, false, false },
