...
#endif
#ifndef A90_DOOMGENERIC_NATIVE_DASHBOARD_MINIMAL
#define A90_DOOMGENERIC_NATIVE_DASHBOARD_MINIMAL 0
#endif
...
static int video_demo_doom_present_large_frame_path(
    ...
    if (verbose) {
        ...
        a90_console_printf("video.demo.doom.dashboard.hw_plane.fb_id=%u\r\n",
                           plane.fb_id);
        a90_console_printf("video.demo.doom.dashboard.hw_plane.atomic_attempted=%d\r\n",
                           plane.atomic_attempted ? 1 : 0);
        ...
        a90_console_printf("video.demo.doom.dashboard.hw_plane.stage_id=%d\r\n",
                           plane.stage);
        a90_console_printf("video.demo.doom.dashboard.hw_plane.crtc_index=%d\r\n",
                           plane.crtc_index);
        a90_console_printf("video.demo.doom.dashboard.hw_plane.cached_crtc_index=%d\r\n",
                           plane.used_cached_crtc_index);
        ...
        a90_console_printf("video.demo.doom.dashboard.hw_plane.atomic_cap_rc=%d\r\n",
                           plane.atomic_cap_rc);
        a90_console_printf("video.demo.doom.dashboard.hw_plane.fetch_resources_rc=%d\r\n",
                           plane.fetch_resources_rc);
        a90_console_printf("video.demo.doom.dashboard.hw_plane.atomic_props_rc=%d\r\n",
                           plane.atomic_props_rc);
        a90_console_printf("video.demo.doom.dashboard.hw_plane.atomic_prop_count=%u\r\n",
                           plane.atomic_prop_count);
        a90_console_printf("video.demo.doom.dashboard.hw_plane.atomic_commit_rc=%d\r\n",
                           plane.atomic_commit_rc);
        a90_console_printf("video.demo.doom.dashboard.hw_plane.legacy_setplane_rc=%d\r\n",
                           plane.legacy_setplane_rc);
...
static int video_demo_doom_draw_minimal_dashboard(
    ...
    snprintf(line, sizeof(line),
             "fast dashboard  frame %u/%u  poll %u  frame_ms %u",
             frame_index,
             total_frames,
             poll_count,
             status.loop_frame_ms);
    ...
    snprintf(line, sizeof(line),
             ...
             roles,
             input_rc);
    video_demo_doom_dashboard_draw_line(fb, margin, &row_y, panel_w,
                                        line, 0xffffff, scale);
    snprintf(line, sizeof(line),
             "ENGINE %s  UDP %u  helper=%d",
             status.engine,
             status.input_udp_port,
             status.helper_executable ? 1 : 0);
    video_demo_doom_dashboard_draw_line(fb, margin, &row_y, panel_w,
...
static int video_demo_doom_draw_native_dashboard(
        ...
        uint32_t poll_count) {
#if A90_DOOMGENERIC_NATIVE_DASHBOARD_MINIMAL
    return video_demo_doom_draw_minimal_dashboard(fb,
                                                  source,
                                                  render,
                                                  verbose,
                                                  frame_index,
