...
static void cmd_help(void) {
    ...
    a90_console_printf("video [status|frame|anim|blitbench|stream --manifest PATH --video-only|cache [status|verify|play] SHA256 [--trust-cache]|cache preset badapple-scale [status|verify|play]]\r\n");
