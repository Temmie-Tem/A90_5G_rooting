...
enum screen_menu_action {
    ...
    SCREEN_MENU_WIFI_STATUS,
    SCREEN_MENU_WIFI_PROFILES,
    SCREEN_MENU_WIFI_SCAN,
    SCREEN_MENU_WIFI_PING,
    ...
    SCREEN_MENU_DEMO_NYAN,
    SCREEN_MENU_DEMO_DOOM,
...
enum screen_app_id {
    ...
    SCREEN_APP_LOG,
    SCREEN_APP_NETWORK,
    SCREEN_APP_WIFI_STATUS,
    SCREEN_APP_WIFI_PROFILES,
    SCREEN_APP_WIFI_SCAN,
    SCREEN_APP_WIFI_PING,
