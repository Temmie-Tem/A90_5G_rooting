...
/*
 * §0.2 write-probe rungs E1/E2/E3a (self-dd fast-flash tool design §11.2).
 *
 ...
 * PARTNAME=boot, picks one E1 target, four E2 targets, or sixteen E3a targets spread across the
 * observed all-zero sector population in tail slack (past the boot-image content, 1 MiB before the
 * partition end to avoid any AVB footer), REFUSES unless every selected sector reads all-zero,
