/*
 * V2717 phase-aware common-topology hook.
 *
...
#define A90_EVENTS_PATH "/data/local/tmp/a90-acdb-ownget/acdb-v2717-route-first-phase-common-events.jsonl"
...
static void a90_write_event(const char *stage, int32_t code)
{
    ...
    a90_write_str(fd, "{\"event\":\"v2717_route_first_phase_common\",\"stage\":\"");
