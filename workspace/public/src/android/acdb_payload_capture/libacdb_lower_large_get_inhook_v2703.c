/*
 * V2703 lower hidden-node ACDB large-buffer topology GET preload.
 *
...
#define A90_EVENTS_PATH "/data/local/tmp/a90-acdb-ownget/acdb-v2703-lower-large-get-events.jsonl"
