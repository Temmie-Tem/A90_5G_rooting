#!/usr/bin/env python3
"""Build V2925 native-init candidate with Bad Apple A/V sync start-offset correction."""
...
CYCLE = "V2925"
INIT_VERSION = "0.10.41"
INIT_BUILD = "v2925-badapple-sync-offset"
BUILD_TAG = INIT_BUILD
DECISION = "v2925-badapple-sync-offset-source-build-pass"

OUT_DIR = workspace_private_build_path("native-init", BUILD_TAG)
REPORT_PATH = REPO_ROOT / "docs/reports/NATIVE_INIT_V2925_BADAPPLE_SYNC_OFFSET_SOURCE_BUILD_2026-06-20.md"
BOOT_IMAGE = workspace_private_input_path("boot_images", "boot_linux_v2925_badapple_sync_offset.img", legacy_fallback=False)
INIT_BINARY = OUT_DIR / "init_v2925_badapple_sync_offset"
RAMDISK_CPIO = OUT_DIR / "ramdisk_v2925_badapple_sync_offset.cpio"
HELPER_BINARY = OUT_DIR / "a90_android_execns_probe_v469_badapple_sync_offset"

REQUIRED_STRINGS = (
    b"A90 Linux init 0.10.41 (v2925-badapple-sync-offset)",
...
def require_strings(path: Path) -> list[str]:
    ...
    if missing:
        raise RuntimeError(f"missing V2925 boot-image markers: {missing}")
...
def main() -> int:
    ...
    manifest.update({
        ...
        "candidate_type": "badapple-sync-offset-candidate",
        "parent_test_artifact": "v2924-demo-menu-badapple-av-flash-live",
        "badapple_player_hud": {
            "version": 1,
            "source_unit": "V2925",
            "parent_unit": "V2924",
    ...
    (OUT_DIR / "badapple-sync-offset-candidate.json").write_text(json.dumps({
        "candidate_tag": INIT_BUILD,
        "candidate_type": "badapple-sync-offset-candidate",
