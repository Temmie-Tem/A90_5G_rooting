#!/usr/bin/env python3
"""Build V3274 GPU H3 clip/guardband/SU rasterizer probe."""
...
CYCLE = "V3274"
INIT_VERSION = "0.11.63"
INIT_BUILD = "v3274-gpu-h3-clip-guardband-su-probe"
...
REPORT_PATH = (
    ...
    / "docs"
    / "reports"
    / "NATIVE_INIT_V3274_GPU_H3_CLIP_GUARDBAND_SU_SOURCE_BUILD_2026-06-26.md"
)
BOOT_IMAGE = workspace_private_input_path(
    "boot_images",
    "boot_linux_v3274_gpu_h3_clip_guardband_su_probe.img",
    legacy_fallback=False,
)
BASE_BOOT = previous.BOOT_IMAGE
INIT_BINARY = OUT_DIR / "init_v3274_gpu_h3_clip_guardband_su_probe"
RAMDISK_CPIO = OUT_DIR / "ramdisk_v3274_gpu_h3_clip_guardband_su_probe.cpio"
HELPER_BINARY = OUT_DIR / "a90_android_execns_probe_v600_gpu_h3_clip_guardband_su_probe"

ENGINE_BINARY = OUT_DIR / "a90_doomgeneric_private_engine_v3274"
ENGINE_ADAPTER_SOURCE = OUT_DIR / "a90_doomgeneric_native_bridge_v3274.c"
ENGINE_ADAPTER_OBJECT = OBJ_DIR / "a90_doomgeneric_native_bridge_v3274.o"
ENGINE_RAMDISK_PATH = "bin/a90_doomgeneric_private_engine_v3274"
ENGINE_REMOTE_PATH = "/" + ENGINE_RAMDISK_PATH
ENGINE_NAME = "doomgeneric-private-link-v3274-gpu-h3-clip-guardband-su-probe"

FRAME_PATH = "/tmp/a90-doomgeneric-v3274-raw-fallback-frame.xbgr8888"
SHARED_FRAME_PATH = "/tmp/a90-doomgeneric-v3274-shared-frame.bin"
INPUT_STATE_PATH = "/tmp/a90-doomgeneric-v3274-input.state"
INPUT_SOCKET_PATH = "/tmp/a90-doomgeneric-v3274-input.sock"
PACE_SOCKET_PATH = "/tmp/a90-doomgeneric-v3274-pace.sock"
TICK_TELEMETRY_PATH = "/tmp/a90-doomgeneric-v3274-tick-telemetry.txt"
AUDIO_PCM_STREAM_PATH = "/cache/a90-runtime/a90-doomgeneric-v3274-sfx.pcmstream"

FRAME_SCALE = "1:1-demo-hud-large-groups-gpu-h3-clip-guardband-su-probe"
FRAME_IPC = "shared-mmap-direct-blit-demo-hud-large-groups-gpu-h3-clip-guardband-su-probe"

INPUT_THREAD_MARKER = previous.INPUT_THREAD_MARKER.replace("v3268", "v3274")
TIME_MODEL_MARKER = previous.TIME_MODEL_MARKER.replace("v3268", "v3274")
DEMO_HUD_MARKER = previous.DEMO_HUD_MARKER.replace("v3268", "v3274")
PACED_TIME_MARKER = previous.PACED_TIME_MARKER.replace("v3268", "v3274")
TICK_TELEMETRY_MARKER = previous.TICK_TELEMETRY_MARKER.replace("v3268", "v3274")
SCALE_MARKER = previous.SCALE_MARKER.replace("v3268", "v3274")
PHASE_TELEMETRY_MARKER = previous.PHASE_TELEMETRY_MARKER.replace("v3268", "v3274")
GAMETIC_FRAME_TELEMETRY_MARKER = previous.GAMETIC_FRAME_TELEMETRY_MARKER.replace("v3268", "v3274")
SFX_STREAM_MARKER = "a90.doomgeneric.v3274.audio=real-sfx-pcm-stream-gpu-h3-clip-guardband-su-probe"
SOUND_MODE = "native-doom-sfx-gpu-h3-clip-guardband-su-probe-v3274"

SFX_BACKEND_SOURCE = OUT_DIR / "a90_doomgeneric_native_sfx_v3274.c"
SDL_MIXER_STUB = OUT_DIR / "SDL_mixer.h"

SCOPE = "first-triangle-h3-clip-guardband-su-rasterizer-a6xx-hlsq-negative-audit-output-routing-sp-frontend-prog-id-state-sp-const-fs-output-cntl-raster-mode-cp-set-mode-window-offset-visibility-packets-vpc-so-override-off-sysmem-bin-control-sp-update-cntl-compiler-vs-instrlen-cache-invalidate-rb-render-cntl-r0-output-shader"
...
HLSQ_ROUND4_AUDIT = "Local A6xx XML/fd6 draw path uses SP program config plus CP_LOAD_STATE6, not legacy HLSQ_CONTROL/HLSQ_xS_CNTL registers"
SP_PS_OUTPUT_CNTL_SOURCE = "Mesa freedreno A6xx fd6_program invalid depth/sampmask/stencil regids plus RB/SP MRT count one"
SP_PS_OUTPUT_CNTL_VALUE = "0xfcfcfc00"
RB_PS_OUTPUT_CNTL_VALUE = "0x00000000"
RB_PS_MRT_CNTL_VALUE = "0x00000001"
SP_PS_MRT_CNTL_VALUE = "0x00000001"
CLIP_GUARDBAND_SU_SOURCE = "Mesa freedreno A6xx fd6 rasterizer plus guardband state"
GRAS_CL_CNTL_VALUE = "0x000000c0"
GRAS_CL_GUARDBAND_CLIP_ADJ_VALUE = "0x0007fdff"
GRAS_SU_CNTL_VALUE = "0x00000814"
GRAS_SU_POINT_MINMAX_VALUE = "0xffc00001"
GRAS_SU_POINT_SIZE_VALUE = "0x00000010"
GRAS_SU_POLY_OFFSET_SCALE_VALUE = "0x00000000"
GRAS_SU_POLY_OFFSET_OFFSET_VALUE = "0x00000000"
GRAS_SU_POLY_OFFSET_OFFSET_CLAMP_VALUE = "0x00000000"
...
def _rewrite_v3274_bytes(item: bytes) -> bytes:
    replacements = {
        ...
        b"a90-doomgeneric-v3268": b"a90-doomgeneric-v3274",
        b"a90.doomgeneric.v3268": b"a90.doomgeneric.v3274",
        b"v3268": b"v3274",
        b"V3268": b"V3274",
        b"gpu-h3-raster-mode-probe": b"gpu-h3-clip-guardband-su-probe",
...
def _rewrite_v3274_text(text: str) -> str:
    for old, new in (
        ...
        ("a90-doomgeneric-v3268", "a90-doomgeneric-v3274"),
        ("a90.doomgeneric.v3268", "a90.doomgeneric.v3274"),
        ("v3268", "v3274"),
        ("V3268", "V3274"),
        ("gpu-h3-raster-mode-probe", "gpu-h3-clip-guardband-su-probe"),
...
GPU_H3_CLIP_GUARDBAND_SU_MARKERS = (
    ...
    b"gpu.h3.draw.fs_output_cntl_source=mesa-freedreno-a6xx-fd6-program-invalid-depth-sampmask-stencil-regids-and-rb-sp-mrt-count-one",
    b"gpu.h3.draw.rb_ps_output_cntl=0x%x",
    b"gpu.h3.draw.rb_ps_mrt_cntl=0x%x",
    b"gpu.h3.draw.sp_ps_output_cntl=0x%x",
    b"gpu.h3.draw.sp_ps_mrt_cntl=0x%x",
    b"gpu.h3.draw.clip_guardband_su_source=mesa-freedreno-a6xx-fd6-rasterizer-plus-guardband-state",
    b"gpu.h3.draw.gras_cl_cntl=0x%x",
    b"gpu.h3.draw.gras_cl_guardband_clip_adj=0x%x",
    b"gpu.h3.draw.gras_su_cntl=0x%x",
    b"gpu.h3.draw.gras_su_point_minmax=0x%x",
    b"gpu.h3.draw.gras_su_point_size=0x%x",
    b"gpu.h3.draw.gras_su_poly_offset_scale=0x%x",
    b"gpu.h3.draw.gras_su_poly_offset_offset=0x%x",
    b"gpu.h3.draw.gras_su_poly_offset_offset_clamp=0x%x",
...
REQUIRED_STRINGS = tuple(_rewrite_v3274_bytes(item) for item in previous.REQUIRED_STRINGS) + (
...
def _minimal_gpu_h3_manifest() -> dict[str, Any]:
    ...
    manifest.update({
        ...
        "hlsq_round4_audit": HLSQ_ROUND4_AUDIT,
        "sp_ps_output_cntl_source": SP_PS_OUTPUT_CNTL_SOURCE,
        "sp_ps_output_cntl_value": SP_PS_OUTPUT_CNTL_VALUE,
        "rb_ps_output_cntl_value": RB_PS_OUTPUT_CNTL_VALUE,
        "rb_ps_mrt_cntl_value": RB_PS_MRT_CNTL_VALUE,
        "sp_ps_mrt_cntl_value": SP_PS_MRT_CNTL_VALUE,
        "clip_guardband_su_source": CLIP_GUARDBAND_SU_SOURCE,
        "gras_cl_cntl_value": GRAS_CL_CNTL_VALUE,
        "gras_cl_guardband_clip_adj_value": GRAS_CL_GUARDBAND_CLIP_ADJ_VALUE,
        "gras_su_cntl_value": GRAS_SU_CNTL_VALUE,
        "gras_su_point_minmax_value": GRAS_SU_POINT_MINMAX_VALUE,
        "gras_su_point_size_value": GRAS_SU_POINT_SIZE_VALUE,
        "gras_su_poly_offset_scale_value": GRAS_SU_POLY_OFFSET_SCALE_VALUE,
        "gras_su_poly_offset_offset_value": GRAS_SU_POLY_OFFSET_OFFSET_VALUE,
        "gras_su_poly_offset_offset_clamp_value": GRAS_SU_POLY_OFFSET_OFFSET_CLAMP_VALUE,
        ...
        "output_routing_registers": {
            "RB_PS_OUTPUT_CNTL": "0x0000880b",
            "RB_PS_MRT_CNTL": "0x0000880c",
            "SP_PS_OUTPUT_CNTL": "0x0000a98c",
            "SP_PS_MRT_CNTL": "0x0000a98d",
        },
        "sp_ps_output_cntl_register": "0x0000a98c",
        "clip_guardband_su_registers": {
            "GRAS_CL_CNTL": "0x00008000",
            "GRAS_CL_GUARDBAND_CLIP_ADJ": "0x00008006",
            "GRAS_SU_CNTL": "0x00008090",
            "GRAS_SU_POINT_MINMAX": "0x00008091",
            "GRAS_SU_POINT_SIZE": "0x00008092",
            "GRAS_SU_POLY_OFFSET_SCALE": "0x00008095",
            "GRAS_SU_POLY_OFFSET_OFFSET": "0x00008096",
            "GRAS_SU_POLY_OFFSET_OFFSET_CLAMP": "0x00008097",
        },
        ...
        "state_reg_writes_expected": 111,
        "pm4_dwords_expected": 292,
        "shader_payload": SHADER_PAYLOAD,
        "readback": "expect changed pixels if zero-default clip/guardband/SU rasterizer state blocked raster coverage",
        "next_live_validation": [
            "flash-v3274-through-native-init-flash",
            "post-flash-health-check",
            "gpu-h3-clip-guardband-su-timeout-guard",
...
def v3274_adapter_source() -> str:
    return _rewrite_v3274_text(previous.v3268_adapter_source())


def _write_candidate_manifest(manifest: dict[str, Any]) -> None:
    (OUT_DIR / "gpu-h3-clip-guardband-su-probe-candidate.json").write_text(json.dumps({
        "candidate_tag": INIT_BUILD,
        "candidate_type": "gpu-h3-clip-guardband-su-probe-candidate",
        ...
        "adoption_state": "pending-gpu-h3-clip-guardband-su-live-validation",
...
def _overlay_preserved_v3274_ramdisk() -> dict[str, Any]:
    ...
    overlay["mode"] = "preserve-v3268-ramdisk-overlay-v3274-init-helper-engine"
...
def _finalize_manifest_after_overlay(
    ...
    *,
    ...
    manifest["candidate_type"] = "gpu-h3-clip-guardband-su-probe-candidate"
    manifest["adoption_state"] = "pending-gpu-h3-clip-guardband-su-live-validation"
...
def _apply_v3274_overrides() -> None:
    ...
    replacements = {
        ...
        "SFX_BACKEND_SOURCE_TEXT": _rewrite_v3274_text(base.SFX_BACKEND_SOURCE_TEXT),
        "REQUIRED_STRINGS": REQUIRED_STRINGS,
        "render_report": render_report,
        "v3210_adapter_source": v3274_adapter_source,
        "_overlay_preserved_v3208_ramdisk": _overlay_preserved_v3274_ramdisk,
