#!/usr/bin/env python3
"""Run V2201 read-only timer_start timer-object capture.
...
4. use a90_bpf_trace_extract to find the current-boot dominant timer_start
   function pointer;
5. run a90_bpf_timer_object_context filtered to that pointer;
...
REMOTE_CONTEXT = "/cache/bin/a90_bpf_timer_object_context"
...
def main() -> int:
    ...
    try:
        ...
        summary["pass"] = summary["decision"] == "v2201-timer-object-context-captured" and summary["selftest_fail0"]
    except Exception as exc:
        summary["decision"] = "v2201-timer-object-context-failed"
        summary["pass"] = False
