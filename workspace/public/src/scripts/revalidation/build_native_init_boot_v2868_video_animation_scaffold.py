#!/usr/bin/env python3
"""Build V2868 native-init video animation scaffold candidate.

V2868 keeps the V2866 video command surface and adds the first bounded
frame-loop scaffold: `video anim [bars|checker|pulse] [frames] [delay_ms]`.
...
CYCLE = "V2868"
INIT_VERSION = "0.10.21"
INIT_BUILD = "v2868-video-animation-scaffold"
...
REPORT_PATH = (
    ...
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2868_VIDEO_ANIMATION_SCAFFOLD_SOURCE_BUILD_2026-06-19.md"
)
BOOT_IMAGE = workspace_private_input_path(
    "boot_images", "boot_linux_v2868_video_animation_scaffold.img", legacy_fallback=False
)
INIT_BINARY = OUT_DIR / "init_v2868_video_animation_scaffold"
RAMDISK_CPIO = OUT_DIR / "ramdisk_v2868_video_animation_scaffold.cpio"
HELPER_BINARY = OUT_DIR / "a90_android_execns_probe_v455_video_animation_scaffold"


def configure_base_for_v2868() -> None:
    v2859.CYCLE = CYCLE
...
def main() -> int:
    ...
    manifest.update({
        ...
        "candidate_type": "video-animation-scaffold-candidate",
    ...
    (OUT_DIR / "video-animation-scaffold-candidate.json").write_text(json.dumps({
        "candidate_tag": INIT_BUILD,
        "candidate_type": "video-animation-scaffold-candidate",
        ...
        "adoption_state": "pending-live-validation",
        "note": "V2868 packages the bounded native video animation scaffold for rollbackable live validation.",
