#!/usr/bin/env python3
"""Build V2828 native-init audio route-map safety-label candidate."""
...
CYCLE = "V2828"
INIT_VERSION = "0.10.6"
INIT_BUILD = "v2828-audio-route-map-safety"
...
REPORT_PATH = (
    ...
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2828_AUDIO_ROUTE_MAP_SAFETY_SOURCE_BUILD_2026-06-19.md"
)
BOOT_IMAGE = workspace_private_input_path(
    "boot_images", "boot_linux_v2828_audio_route_map_safety.img", legacy_fallback=False
)
BASE_BOOT = v2807.BASE_BOOT
INIT_BINARY = OUT_DIR / "init_v2828_audio_route_map_safety"
RAMDISK_CPIO = OUT_DIR / "ramdisk_v2828_audio_route_map_safety.cpio"
HELPER_BINARY = OUT_DIR / "a90_android_execns_probe_v447_audio_route_map_safety"


def configure_v2807_for_v2828() -> None:
    v2807.CYCLE = CYCLE
...
def rewrite_candidate_metadata() -> None:
    ...
    manifest.update({
        ...
        "parent_test_artifact": "v2826-audio-menu-screens",
    ...
    (OUT_DIR / "audio-observability-candidate.json").write_text(json.dumps({
        ...
        "rollback_baseline": "v2321-usb-clean-identity-rodata",
        "adoption_state": "pending-live-validation",
        "note": "V2828 carries V2827 audio observability plus explicit route-map safety labels; live validation is required before adoption.",
    }, indent=2, sort_keys=True) + "\n", encoding="utf-8")


def main() -> int:
    configure_v2807_for_v2828()
