#!/usr/bin/env python3
"""V2823 live validation for the V2822 audio screenapp status image."""
...
CYCLE = "V2823"
BUILD_MANIFEST = runner.ROOT / "workspace/private/builds/native-init/v2822-audio-screenapp-status/manifest.json"
CANDIDATE_IMAGE = runner.ROOT / "workspace/private/inputs/boot_images/boot_linux_v2822_audio_screenapp_status.img"
CANDIDATE_VERSION = "0.10.3"
CANDIDATE_TAG = "v2822-audio-screenapp-status"
REPORT_PATH = runner.ROOT / "docs/reports/NATIVE_INIT_V2823_AUDIO_SCREENAPP_STATUS_LIVE_2026-06-19.md"
