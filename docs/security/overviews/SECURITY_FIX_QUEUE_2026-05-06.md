...
Source relationship analysis: `docs/security/overviews/SECURITY_FINDINGS_RELATIONSHIP_2026-05-06.md`
Current exposure map: `docs/security/overviews/SECURITY_FINDINGS_CURRENT_EXPOSURE_2026-05-06.md`
...
Closure review: `docs/security/overviews/SECURITY_FINDINGS_CLOSURE_REVIEW_2026-05-07.md`
...
`docs/security/scans/SECURITY_FRESH_SCAN_V133_2026-05-07.md`.

v134 exposure guardrail was flash-verified, and local targeted rescan result is
PASS=15, WARN=1, FAIL=0 in
`docs/security/scans/SECURITY_FRESH_SCAN_V134_2026-05-07.md`. The remaining warning is
...
v135 policy matrix was flash-verified, and local targeted rescan result is
PASS=16, WARN=1, FAIL=0 in
`docs/security/scans/SECURITY_FRESH_SCAN_V135_2026-05-07.md`. The remaining warning is
still the accepted USB-local/localhost root-control boundary; the new matrix
...
PASS=16, WARN=1, FAIL=0 in
`docs/security/scans/SECURITY_FRESH_SCAN_V136_2026-05-07.md`. The remaining warning is
...
`docs/security/scans/SECURITY_FRESH_SCAN_V137_2026-05-07.md`. The remaining warning is
...
`docs/security/scans/SECURITY_FRESH_SCAN_V138_2026-05-08.md`. The remaining warning is
...
- Batch 0 output is recorded in `docs/security/overviews/SECURITY_FINDINGS_CURRENT_EXPOSURE_2026-05-06.md`.
