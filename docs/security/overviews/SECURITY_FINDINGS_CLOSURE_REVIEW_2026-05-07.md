...
`docs/security/overviews/SECURITY_FINDINGS_CURRENT_EXPOSURE_2026-05-06.md` intentionally
...
v133 rescan is recorded in `docs/security/scans/SECURITY_FRESH_SCAN_V133_2026-05-07.md`
