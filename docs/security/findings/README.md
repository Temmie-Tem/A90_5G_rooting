...
| F023 | `low` | `partial-v123` | Auto-menu busy-gate bypass allows risky root commands | [`F023-auto-menu-busy-gate-bypass-allows-risky-root-commands.md`](F023-auto-menu-busy-gate-bypass-allows-risky-root-commands.md) | stage3/linux_init/init_v72.c <br> stage3/linux_init/init_v70.c |
