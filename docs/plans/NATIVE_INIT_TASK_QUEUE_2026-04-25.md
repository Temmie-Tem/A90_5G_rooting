...
이 문서는 `A90 Linux init 0.9.35 (v135)` verified 이후 바로 실행할 작업 큐다.
...
- local artifact retention: `v135` latest, `v134` rollback, `v48` known-good만 보존하고 나머지 ignored stage3 산출물은 정리 가능
