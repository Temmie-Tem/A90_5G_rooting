...
- latest verified official version: `0.9.12`
- latest verified build tag: `v112`
- latest verified display name: `A90 Linux init 0.9.12 (v112)`
...
- 보존: latest verified `v112`, 직전 rollback `v111`, known-good fallback `v48`
