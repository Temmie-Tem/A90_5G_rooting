...
- latest verified official version: `0.9.4`
- latest verified build tag: `v104`
- latest verified display name: `A90 Linux init 0.9.4 (v104)`
...
- 보존: latest verified `v104`, 직전 rollback `v103`, known-good fallback `v48`
