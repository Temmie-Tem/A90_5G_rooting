...
- latest verified official version: `0.8.30`
- latest verified build tag: `v99`
- latest verified display name: `A90 Linux init 0.8.30 (v99)`
...
- 보존: latest verified `v99`, 직전 rollback `v98`, known-good fallback `v48`
