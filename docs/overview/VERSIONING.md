...
- latest verified official version: `0.8.29`
- latest verified build tag: `v98`
- latest verified display name: `A90 Linux init 0.8.29 (v98)`
...
- 보존: latest verified `v98`, 직전 rollback `v97`, known-good fallback `v48`
