...
- latest verified official version: `0.9.0`
- latest verified build tag: `v100`
- latest verified display name: `A90 Linux init 0.9.0 (v100)`
...
- 보존: latest verified `v100`, 직전 rollback `v99`, known-good fallback `v48`
