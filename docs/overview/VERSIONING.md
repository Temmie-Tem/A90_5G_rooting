...
- latest verified official version: `0.9.15`
- latest verified build tag: `v115`
- latest verified display name: `A90 Linux init 0.9.15 (v115)`
...
- 보존: latest verified `v115`, 직전 rollback `v114`, known-good fallback `v48`
