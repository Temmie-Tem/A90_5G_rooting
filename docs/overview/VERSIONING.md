...
- latest verified official version: `0.9.13`
- latest verified build tag: `v113`
- latest verified display name: `A90 Linux init 0.9.13 (v113)`
...
- 보존: latest verified `v113`, 직전 rollback `v112`, known-good fallback `v48`
