...
- latest verified official version: `0.9.5`
- latest verified build tag: `v105`
- latest verified display name: `A90 Linux init 0.9.5 (v105)`
...
- 보존: latest verified `v105`, 직전 rollback `v104`, known-good fallback `v48`
