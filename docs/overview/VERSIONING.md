...
- latest verified official version: `0.9.14`
- latest verified build tag: `v114`
- latest verified display name: `A90 Linux init 0.9.14 (v114)`
...
- 보존: latest verified `v114`, 직전 rollback `v113`, known-good fallback `v48`
