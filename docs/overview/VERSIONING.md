...
- latest verified official version: `0.9.2`
- latest verified build tag: `v102`
- latest verified display name: `A90 Linux init 0.9.2 (v102)`
...
- 보존: latest verified `v102`, 직전 rollback `v101`, known-good fallback `v48`
