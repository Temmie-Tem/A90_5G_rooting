...
- latest verified official version: `0.9.11`
- latest verified build tag: `v111`
- latest verified display name: `A90 Linux init 0.9.11 (v111)`
...
- 보존: latest verified `v111`, 직전 rollback `v110`, known-good fallback `v48`
