...
- latest verified official version: `0.9.3`
- latest verified build tag: `v103`
- latest verified display name: `A90 Linux init 0.9.3 (v103)`
...
- 보존: latest verified `v103`, 직전 rollback `v102`, known-good fallback `v48`
