...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1314 PASS → V1315 targeted tracefs-event preflight` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1315** — targeted tracefs-event preflight
   (V1314에서 provider-internal first-power-on event visibility가 다음 안전 prerequisite로 선택됨)
