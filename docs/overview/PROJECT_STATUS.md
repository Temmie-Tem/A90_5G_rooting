...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1318 PASS → V1319 GPIO135-to-GPIO142/PCIe response classifier` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1319** — GPIO135-to-GPIO142/PCIe response classifier
   (V1318에서 `fw=esoc0`, GPIO1270 toggle, GPIO135 high, GPIO142 absent 확인)
