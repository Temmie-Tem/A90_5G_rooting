...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1273` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1274** — helper v266 deploy-only
   (V1273에서 빌드된 `a90_android_execns_probe v266`을 `/cache/bin`에 배포하고
   SHA/selftest만 확인)
