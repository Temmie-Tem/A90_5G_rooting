...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1284 SOURCE/BUILD PASS → V1285 helper v269 deploy` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1285** — deploy-only helper v269
   (`a90_android_execns_probe v269`, sha256
   `dbb1f67652913ffe94b1f083a082d8f221820040b9f28e08b226eb1e0a50fc83`)
2. **V1286** — rerun bounded PCIe/GDSC/klogctl response sampler
   (`/dev/kmsg` first, read-only `syslog(SYSLOG_ACTION_READ_ALL)` fallback,
   `kmsg_source` summary)
