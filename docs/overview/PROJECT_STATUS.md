...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1317 PASS → V1318 critical-only lower trace collector` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1318** — critical-only lower trace collector
   (V1317에서 V1316 saved trace lines가 IRQ/clock noise 중심이고 target line이 없음 확인)
