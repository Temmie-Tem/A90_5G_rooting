...
- 최신 verified build: `stage3/boot_linux_v82.img` (`A90 Linux init 0.8.13 (v82)`)
- 최신 verified source: `stage3/linux_init/init_v82.c` + `stage3/linux_init/v82/*.inc.c` + `stage3/linux_init/a90_config.h` + `stage3/linux_init/a90_util.c/h` + `stage3/linux_init/a90_log.c/h` + `stage3/linux_init/a90_timeline.c/h`
...
- 상세 최신 verified 상태: `docs/reports/NATIVE_INIT_V82_LOG_TIMELINE_2026-04-29.md`
...
**현재 버전**: `init_v82` (`stage3/boot_linux_v82.img`) / `0.8.13 (v82)`
...
**확보된 관찰/제어 범위 (v82 verified build 기준):**
...
우선순위 순 (v82 verified build 이후):

1. **v83 console + shell + cmdproto boundary** — console 입출력, shell dispatch, framed protocol 책임 분리
2. **v84 run/service/netservice management** — timeout/cancel/zombie reap과 장기 실행 helper를 service 단위로 정리
