...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1291 HOST PASS → V1292 dynamic PCIe/GDSC/eSoC sequencing plan` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1292** — dynamic PCIe/GDSC/eSoC sequencing plan
   (V1291 closed static GPIO135/GPIO142 and PMIC9 shape as the shortest blocker)
