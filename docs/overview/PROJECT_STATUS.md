...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1288 SOURCE/BUILD PASS → V1289 helper v270 deploy` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1289** — deploy-only helper v270
   (`a90_android_execns_probe v270`, sha256
   `f1748fdc9c64a748c3270cd02a2b9bb796065b79632849e7384c2f37910f6e88`)
2. **V1290** — rerun bounded no-write TLMM/PCIe response sampler
   (exact `gpio135`/`gpio142` target scan plus PMIC9/GDSC/klogctl response fields)
