...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1302 PASS → V1303 bounded compact dense live rerun` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1303** — bounded compact dense live rerun with helper `v273`
   (V1302에서 `/cache/bin/a90_android_execns_probe` sha confirmed)
