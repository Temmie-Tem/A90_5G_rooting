...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1290 LIVE PASS → V1291 static GPIO parity classifier` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1291** — host-only static GPIO parity classifier
   (V1290 GPIO135/GPIO142 exact target lines match Android-positive static shape)
