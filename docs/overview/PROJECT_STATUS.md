...
- 최신 verified build: `stage3/boot_linux_v81.img` (`A90 Linux init 0.8.12 (v81)`)
- 최신 verified source: `stage3/linux_init/init_v81.c` + `stage3/linux_init/v81/*.inc.c` + `stage3/linux_init/a90_config.h` + `stage3/linux_init/a90_util.c/h`
...
- 상세 최신 verified 상태: `docs/reports/NATIVE_INIT_V81_CONFIG_UTIL_2026-04-29.md`
...
**현재 버전**: `init_v81` (`stage3/boot_linux_v81.img`) / `0.8.12 (v81)`
...
**확보된 관찰/제어 범위 (v81 verified build 기준):**
...
우선순위 순 (v81 verified build 이후):

1. **v82 log/timeline module extraction** — `a90_log.c/h`, `a90_timeline.c/h`를 실제 API로 승격
