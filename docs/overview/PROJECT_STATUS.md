...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1272` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1273** — source/build-only helper v266 block sampler
   (V1272 결과 기준으로 PMIC GPIO9/TLMM GPIO135/142의 주변 debugfs GPIO/pinconf
   block을 read-only로 캡처하도록 기존 response sampler 확장)
