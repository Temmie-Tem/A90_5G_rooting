...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1319 PASS → V1320 mdm_helper/ks/MHI response-contract classifier` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1320** — `mdm_helper`/`ks`/MHI response-contract classifier
   (V1319에서 GPIO135 high 이후 GPIO142/PCIe/MHI/WLFW response absent로 blocker 재정의)
