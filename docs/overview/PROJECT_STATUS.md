...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1316 PASS → V1317 lower trace-line classifier` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1317** — lower trace-line classifier
   (V1316에서 `mdm_subsys_powerup` window 중 regulator/gpio/PIL critical events 포착)
