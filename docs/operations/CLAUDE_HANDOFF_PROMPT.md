...
목표는 **먼저 상태를 확인하고, stable v48를 망가뜨리지 않게 하는 것**이다.
...
- stable native init: A90 Linux init v48
- stable source: stage3/linux_init/init_v48.c
- stable boot image: stage3/boot_linux_v48.img
- stable boot image SHA256:
...
- 새 실험 버전은 v50 이상으로 잡고, v48에서 최소 diff로 시작한다.
...
- bridge에서 A90 Linux init v48이 나오면 native init stable 상태다.
