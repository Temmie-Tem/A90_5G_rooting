...
source allocations, and redacts the owned pointers and observed raw bytes from public output. The `strpbrk` proof allocates owned haystack and accept-set strings, requires the
