...
```text
Run ID: V2827
Native init: A90 Linux init 0.10.5 (v2826-audio-menu-screens)
Build tag: v2826-audio-menu-screens
...
Evidence: V2826 source/build and V2827 audio status/selftest/screenapp route-map live validation
Safety rollback net: v2321 remains the flash-gate rollback target until AGENTS.md is deliberately updated
```
