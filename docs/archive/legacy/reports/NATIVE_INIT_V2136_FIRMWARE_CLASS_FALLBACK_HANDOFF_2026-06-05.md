...
- Cycle: `V2136`
- Decision: `v2136-firmware-class-request-entry-captured-still-qdf-ini-rollback-pass`
...
- Evidence: `tmp/wifi/v2136-firmware-class-fallback-handoff`
- Inner handoff: `tmp/wifi/v2136-firmware-class-fallback-handoff/v2135-handoff/manifest.json`

## Matrix

| area | value | detail |
| --- | --- | --- |
| artifact | True | helper=a90_android_execns_probe v425 |
| fwclass_path | True | restore=True current=/vendor/firmware_mnt/image original=/vendor/firmware_mnt/image |
| fallback | True | entries=16 interesting=3 safe_phases=2 |
...
| phase | value | detail |
| --- | --- | --- |
| after_boot_wlan_trigger | safe=True entries=15 interesting=3 | path=/mnt/vendor/firmware timeout=60 emitted=15 |
| after_boot_wlan_long_window | safe=True entries=1 interesting=0 | path=/mnt/vendor/firmware timeout=60 emitted=1 |

## Firmware Class Entries

- `after_boot_wlan_trigger` root `0` entry `2` type `symlink` path `/sys/class/firmware/wlan!qca_cld!WCNSS_qcom_cfg.ini` preview `../../devices/virtual/firmware/wlan!qca_cld!WCNSS_qcom_cfg.ini` read `0/0`
- `after_boot_wlan_trigger` root `1` entry `0` type `dir` path `/sys/devices/virtual/firmware/wlan!qca_cld!WCNSS_qcom_cfg.ini` preview `empty` read `0/0`
- `after_boot_wlan_trigger` root `1` entry `1` type `file` path `/sys/devices/virtual/firmware/wlan!qca_cld!WCNSS_qcom_cfg.ini/uevent` preview `FIRMWARE=wlan/qca_cld/WCNSS_qcom_cfg.ini` read `0/0`
...
- `after_boot_wlan_trigger` pid `6` comm `kworker/u16:0` target `0` wchan `diag_socket_read` stack `[<0000000000000000>] __switch_to+0x10c/0x120 | [<0000000000000000>] diag_socket_read+0x124/0x778 | [<0000000000000000>] diagfwd_channel_read+0x12c/0x178 | [<0000000000000000>] socket_read_work_fn+0x8c/0x208 | [<0000000000000000>] process_one_work+0x260/0x460 | [<0000000000000000>] worker_thread+0x24c/0x460 | [<0000000000000000>] kthread+0x120/0x138 | [<0000000000000000>] ret_from_fork+0x10/0x1c`
...
- `after_boot_wlan_long_window` pid `6` comm `kworker/u16:0` target `0` wchan `diag_socket_read` stack `[<0000000000000000>] __switch_to+0x10c/0x120 | [<0000000000000000>] diag_socket_read+0x124/0x778 | [<0000000000000000>] diagfwd_channel_read+0x12c/0x178 | [<0000000000000000>] socket_read_work_fn+0x8c/0x208 | [<0000000000000000>] process_one_work+0x260/0x460 | [<0000000000000000>] worker_thread+0x24c/0x460 | [<0000000000000000>] kthread+0x120/0x138 | [<0000000000000000>] ret_from_fork+0x10/0x1c`
...
- `after_boot_wlan_trigger` pid `143` comm `kworker/1:1` wchan `_request_firmware` stack `[<0000000000000000>] __switch_to+0x10c/0x120 | [<0000000000000000>] _request_firmware+0x638/0x770 | [<0000000000000000>] request_firmware+0x44/0x70 | [<0000000000000000>] pil_boot+0xd8/0x15e0 | [<0000000000000000>] subsys_powerup+0x2c/0x40 | [<0000000000000000>] __subsystem_get+0x150/0x320 | [<0000000000000000>] subsystem_get_with_fwname+0x10/0x20 | [<0000000000000000>] slpi_load_fw+0x68/0x108`
- `after_boot_wlan_trigger` pid `346` comm `kworker/u16:11` wchan `_request_firmware` stack `[<0000000000000000>] __switch_to+0x10c/0x120 | [<0000000000000000>] _request_firmware+0x638/0x770 | [<0000000000000000>] request_firmware+0x44/0x70 | [<0000000000000000>] qdf_file_read+0x3c/0xf0 | [<0000000000000000>] qdf_ini_parse+0x48/0x228 | [<0000000000000000>] cfg_parse+0x1330/0x13b8 | [<0000000000000000>] hdd_context_create+0xd0/0xd58 | [<0000000000000000>] wlan_hdd_pld_probe+0x250/0x370`

## Focused Indication

| edge | hits | detail |
| --- | --- | --- |
| qmi_cb | 2 | cnss-daemon-634   [003] ....     9.165093: wlfw_qmi_ind_cb_entry: (0x5556c03100) msg_id=0x2b payload_len=0x0 |
| samples | 2 | cnss-daemon-634   [003] ....     9.165093: wlfw_qmi_ind_cb_entry: (0x5556c03100) msg_id=0x2b payload_len=0x0 \| cnss-daemon-634   [000] ....    14.172437: wlfw_qmi_ind_cb_entry: (0x5556c03100) msg_id=0x21 payload_len=0x0 |
