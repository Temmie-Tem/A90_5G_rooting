...
- Decision: `v3111-doomgeneric-hw-plane-diagnostics-cpu-fallback-observed-before-rollback`
- Result before rollback: `1`
- Loop classification: `cpu-fallback-observed`
- Track: DOOM large-frame scale-path optimization.
- Candidate: `A90 Linux init 0.10.110 (v3110-doomgeneric-hw-plane-diagnostics)`
- Candidate image: `workspace/private/inputs/boot_images/boot_linux_v3110_doomgeneric_hw_plane_diagnostics.img`
- Candidate SHA256: `71257ef7fdc9636caa5d40d0c956a59cce36bce7a61ba59beed268bf77d34f57`
- Private run dir: `workspace/private/runs/video/v3111-doomgeneric-hw-plane-diagnostics-live-20260623-104705`
- Live execution: `1`
...
- HW plane stage/id: `fetch-resources` / `3`
- HW plane counts plane/compatible/idle_xbgr: `0` / `0` / `0`
- HW plane client caps universal/atomic rc: `0` / `0`
- Frame mode/scale/path: `minimal-large-hw-plane-scale` / `3:2` / `drm-plane-srcdst`
- Timing draw avg/max us: `4603` / `4913`
- Timing total avg/max us: `11212` / `11309`
- Flip events: `180` delta avg/max us: `16627` / `16650` stable=`1`
