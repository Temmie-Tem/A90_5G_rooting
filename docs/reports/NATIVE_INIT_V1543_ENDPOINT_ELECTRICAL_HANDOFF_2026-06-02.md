# Native Init V1543 Wi-Fi Test Boot Handoff

## Summary

- Cycle: `V1543`
- Type: bounded live test-boot handoff with rollback
- Decision: `v1543-test-boot-downstream-progress-rollback-pass`
- Result: PASS
- Reason: test boot produced downstream Wi-Fi/PCIe evidence and rollback verified
- Evidence: `tmp/wifi/v1543-endpoint-electrical-handoff`
...
- `pid1_rc1_watcher_result_file`: `state=triggered source=/proc/kmsg trigger_mode=sysfs_client_enumerate write_rc=0 errno=0 detect_elapsed_ms=7426 write_elapsed_ms=24333 delay_ms=0 retry_count=0 retry_delay_ms=0 line=<3>[    9.206492]  [2:    cnss-daemon:  603] __netlink_sendskb(1245) skb:000000002ff5f024 queued sk: 000000001fb1a6e6`
- `pid1_rc1_window_sampler_requested`: `None`
- `pid1_rc1_window_result_summary`: `None`
- `pid1_rc1_window_result_file`: `state=armed sampler=auto-v1485-wifi-readiness-test detect_elapsed_ms=7426 delay_ms=0 exact_provider_line=0 long_provider_window=0 tracepoint_sampler=0 pil_tracepoint_sampler=0 sysfs_client_enumerate=1 trigger_mode=sysfs_client_enumerate line=<3>[ 9.206492] [2: cnss-daemon: 603] __netlink_sendskb(1245) skb:000000002ff5f024 queued sk: 000000001fb1a6e6 <3>[ 9.206517] [2: cnss-daemon: 60`
...
- Test image: `tmp/wifi/v1541-endpoint-electrical-observer-test-boot/boot_linux_v1541_wifi_test.img`
- Rollback image: `stage3/boot_linux_v724.img`

## Next

Treat `rc1-ltssm-link-failed-no-l0` as the fixed diagnostic outcome for this
handoff. The test image reached RC1 PHY/LTSSM through the sysfs/client
enumerate writer, but the endpoint did not enter L0 and no MHI/WLFW/BDF/
FW-ready/`wlan0` downstream marker appeared. Next work should classify this
endpoint electrical evidence and design a lower-overhead pre-fail observer; do
not proceed to firmware/MHI/WLFW or scan/connect, credentials, DHCP/routes, or
external ping until native RC1 L0 and PCI enumeration are proven.
