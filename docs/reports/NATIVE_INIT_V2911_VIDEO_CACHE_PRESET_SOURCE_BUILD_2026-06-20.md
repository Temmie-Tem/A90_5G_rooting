...
- Boot image: `workspace/private/inputs/boot_images/boot_linux_v2911_video_cache_preset.img`
- Boot SHA256: `6a91bb594f3208dbb41440e82a8a60cd86515fa2fddfaddb433f29c122292da3`
- Init: `A90 Linux init 0.10.36 (v2911-video-cache-preset)`
...
- `A90 Linux init 0.10.36 (v2911-video-cache-preset)`
- `video.status.next_cache=video cache [status|verify|play] SHA256 [--trust-cache] [--present pageflip] | video cache preset badapple-scale play [--trust-cache]`
...
- `cache preset badapple-scale [status|verify|play]`
