...
- Decision: `v1831-qipcrtr-local-node-bind-gets-local-port-passive-rollback-pass`
- Result: PASS
...
- Evidence: `tmp/wifi/v1831-qipcrtr-local-node-bind-handoff`
- Rollback attempt: `from-native`
- Rollback ok: `True`
- Post-rollback version evidence: `tmp/wifi/v1831-qipcrtr-local-node-bind-handoff/post-rollback-version-filtered.stdout.txt`
- Post-rollback selftest evidence: `tmp/wifi/v1831-qipcrtr-local-node-bind-handoff/post-rollback-selftest.stdout.txt`
...
- QIPCRTR local-node bind label: `qipcrtr-local-node-bind-gets-local-port-passive`
...
- mode/family/type: `observed-local-node-bind-getsockname-close` / `AF_QIPCRTR` / `SOCK_DGRAM`
- open rc/errno/error: `0` / `` / ``
- before-bind getsockname rc/node/port: `0` / `1` / `0`
- bind request family/node/port: `42` / `1` / `0`
- bind rc/errno/error/skipped/reason: `0` / `` / `` / `` / ``
- after-bind getsockname rc/family/node/port: `0` / `42` / `1` / `24246`
...
- Remote root: `/mnt/sdext/a90/private-property-v317/v1830/dev/__properties__`
