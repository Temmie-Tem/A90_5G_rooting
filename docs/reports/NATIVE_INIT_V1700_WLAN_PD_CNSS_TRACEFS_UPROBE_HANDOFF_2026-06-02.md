...
- Decision: `v1700-cnss-uprobe-unavailable-fallback-needed-rollback-pass`
- Result: PASS
- Reason: one cnss output visibility gate run produced a fixed label and rollback verified; property lookup all_match=1; nonlog_label=cnss-uprobe-unavailable-fallback-needed
- Evidence: `tmp/wifi/v1700-wlan-pd-cnss-tracefs-uprobe-handoff`
...
- Remote root: `/mnt/sdext/a90/private-property-v317/v1699/dev/__properties__`
- Uploaded files: `22`
...
- mode: `tracefs-uprobe-or-proc-fallback`
- tracefs path/available: `/sys/kernel/debug/tracing` / `1`
- uprobe register rc/registered: `-2` / `0`
- uprobe enable rc/enabled: `0` / `0`
- uprobe hit count: `0`
- first hit line: `none`
- cleanup done: `1`
- cnss pid/running: `560` / `1`
- maps text seen / runtime PC: `1` / `0x556cc30c00`
