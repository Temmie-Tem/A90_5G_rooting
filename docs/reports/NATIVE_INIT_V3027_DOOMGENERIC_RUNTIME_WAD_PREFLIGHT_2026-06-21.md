...
- Decision: `v3027-doomgeneric-runtime-wad-staging-preflight-asset-needed`
- Device action: `none` in this host-only unit.
- Preflight OK: `1`
- Live asset ready: `0`
- Public WAD files committed/present: `0`
- Private WAD root exists: `0`
...
- Selected WAD bytes: `not-recorded-asset-absent`
- Selected WAD SHA256: `not-recorded-asset-absent`
- Selected WAD magic: `not-recorded-asset-absent`
...
- Summary: Stage exactly one private IWAD/WAD under workspace/private/demo-assets/doom/wads/ before a WAD-backed command implementation or live smoke can be selected.
