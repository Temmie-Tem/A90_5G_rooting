...
- Init: `A90 Linux init 0.9.286 (v2322-usb-named-lun-identity)`
...
- LUN: `mass_storage.0/lun.0` only; U-B multi-LUN is not included.
- SCSI INQUIRY vendor: `A90-LNX`.
- SCSI INQUIRY product/model: `A90-INTERNAL`.
- SCSI INQUIRY revision: `0001`.
- Exact 28-byte INQUIRY string: `A90-LNX A90-INTERNAL    0001`.
- FAT volume label: `A90INTERNAL`.
- Backing file: `/cache/a90-usb-mass-storage-v2322-internal.img`.
- Backing bytes: `8388608`.
