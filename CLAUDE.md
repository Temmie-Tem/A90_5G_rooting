...
- **Active research cycle**: v831 pending after V830 service-notifier listener success with `msm/modem/wlan_pd` state still `uninit`; next gate should classify modem/WLAN-PD online trigger gap before HAL/connect
